...
var c = {
    file: 'maverick.js', //Name of this file
    visualElements: {
        welcome: {
            visualizer: 'static',
            div: 'welcome',
            parameters: {
                text: '<span style="font-size: 250%">Welcome to Maverick</span>'
            }
        },
        featuredAlerts: {
    ...
    facets: {
        ...
        mbtaAllDepartures: {
            ...
            parameters: {
                destinationFilter: /^Maverick/ //Used to filter out predictions going to this station. Optional.
            }
        },
  /*
    ...
    datasources: {
        ...
        localPredictions: {
            ...
            format: 'MBTA_realtime',
            maxAge: 29000,
            URL: 'http://realtime.mbta.com/developer/api/v2/predictionsbystop?api_key=17xKel6QtUOSVDtGlCgjlg&stop=place-mvbcl&include_service_alerts=false&format=json'
        },
        localRoutes: {
            id: 'source_localRoutesMBTA',
            format: 'MBTA_realtime',
            maxAge: 86400000,
            URL: 'http://realtime.mbta.com/developer/api/v2/routesbystop?api_key=17xKel6QtUOSVDtGlCgjlg&stop=place-mvbcl&format=json'
//            URL: 'http://realtime.mbta.com/developer/api/v2/routes?api_key=17xKel6QtUOSVDtGlCgjlg&format=json'
 //       },
 //       localSchedule: {
