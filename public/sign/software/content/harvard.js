...
var c = {
    file: 'harvard.js', //Name of this file
    visualElements: {
        welcome: {
            visualizer: 'static',
            div: 'welcome',
            parameters: {
                text: '<span style="font-size: 250%">Welcome to Harvard Square</span>'
            }
        },
        featuredAlerts: {
    ...
    facets: {
        ...
        mbtaAllDepartures1: {
            ...
            parameters: {
                destinationFilter: /^Harvard/ //Used to filter out predictions going to this station. Optional.
            }
        },
        mbtaAllDepartures2: {
            generatorFunction: 'departuresFromMBTARealtime',
  ...
  /*
    ...
    datasources: {
        ...
        localPredictions1: {
            ...
            format: 'MBTA_realtime',
            maxAge: 29000,
            URL: 'http://realtime.mbta.com/developer/api/v2/predictionsbystop?api_key=17xKel6QtUOSVDtGlCgjlg&stop=place-harsq&include_service_alerts=false&format=json'
        },
        localPredictions2: {
            id: 'source_localPredictionsMBTA2',
            format: 'MBTA_realtime',
            maxAge: 29000,
            URL: 'http://realtime.mbta.com/developer/api/v2/predictionsbystop?api_key=17xKel6QtUOSVDtGlCgjlg&stop=110&include_service_alerts=false&format=json'
        },
        localRoutes: {
            id: 'source_localRoutesMBTA',
            format: 'MBTA_realtime',
            maxAge: 86400000,
            URL: 'http://realtime.mbta.com/developer/api/v2/routesbystop?api_key=17xKel6QtUOSVDtGlCgjlg&stop=place-harsq&format=json'
//            URL: 'http://realtime.mbta.com/developer/api/v2/routes?api_key=17xKel6QtUOSVDtGlCgjlg&format=json'
 //       },
 //       localSchedule: {
